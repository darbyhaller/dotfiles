...
## Type: String
c.downloads.open_dispatcher = "mupdf"
...
## Type: Font
c.fonts.prompts = '16pt monospace'
...
## Type: FormatString
c.tabs.title.format = '{title} : {private}'
...
'v' : 'http://vim.wikia.com/wiki/Special:Search?query={}' ,
...
config.bind('s', 'download-open')
config.bind('S', 'download-clear')
config.bind('e', 'open-editor')
config.bind(';h', 'hint --rapid all hover')
...
config.bind(';f', 'hint --rapid links')
...
config.bind(',n', 'set content.user_stylesheets ~/.resources/solarized-everything-css/css/solarized-all-sites-dark.css ;; reload')
config.bind(',d', 'set content.user_stylesheets ~/.resources/solarized-everything-css/css/solarized-all-sites-light.css ;; reload')
config.bind(',x', "set content.user_stylesheets '' ;; reload")
...
config.bind('y', 'yank selection --primary', mode='caret')
